...
**Statistics:**
In the dataset there are `r nrow(unique(crime_vote[, c("Year", "Month")]))` months of data from `r length(unique(crime_vote$Territory))` Police Force Areas. From those there are `r sum(crime_vote$Pro_brexit)` pro-brexit areas.
